...
<?php
 ...
 ?>
   ...
   <?php
$id_login = @$_SESSION['kalab'];
$sql = mysqli_query($con,"SELECT * FROM tb_kalab
 WHERE id_kalab = '$id_login'") or die(mysqli_error($con));
	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.php" class="logo">
					...
					<b class="text-white">Menu Kepala Lab</b>
				</a>
		...
		<div class="main-panel">
			<div class="content">
				...
				elseif ($page=='laporan') {
					include 'view/rekap/laporan.php';
				}
				elseif ($page=='') {
