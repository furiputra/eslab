...
--
-- Table structure for table `tb_kalab`
--

CREATE TABLE `tb_kalab` (
  `id_kalab` int(11) NOT NULL,
  `nip` varchar(15) NOT NULL,
  `nama_kalab` varchar(120) NOT NULL,
  `email` varchar(65) NOT NULL,
  `password` varchar(100) NOT NULL,
  `foto` varchar(255) NOT NULL,
  `status` varchar(5) NOT NULL
...
--
-- Dumping data for table `tb_kalab`
--

INSERT INTO `tb_kalab` (`id_kalab`, `nip`, `nama_kalab`, `email`, `password`, `foto`, `status`) VALUES
(1, '123456789011', 'Amiruddin Aziz M.Pd', 'amirudiin@gmail.com', '4ce8e48be6c978348e4a6f4754b050de5581be4b', 'kepala.png', 'Y');

-- --------------------------------------------------------

--
-- Table structure for table `tb_master_matkul`
--

CREATE TABLE `tb_master_matkul` (
...
--
-- Dumping data for table `tb_master_matkul`
--

INSERT INTO `tb_master_matkul` (`id_matkul`, `kode_matkul`, `matkul`) VALUES
...
INSERT INTO `tb_walikelas` (`id_walikelas`, `id_dosen`, `id_mkelas`) VALUES
(1, 2, 1),
(2, 1, 2),
(3, 5, 3),
(4, 6, 1),
...
--
-- Indexes for table `tb_kalab`
--
ALTER TABLE `tb_kalab`
  ADD PRIMARY KEY (`id_kalab`);

--
-- Indexes for table `tb_master_matkul`
--
ALTER TABLE `tb_master_matkul`
...
--
-- AUTO_INCREMENT for table `tb_kalab`
--
ALTER TABLE `tb_kalab`
  MODIFY `id_kalab` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tb_master_matkul`
--
ALTER TABLE `tb_master_matkul`
