...
<head>
	...
	<title>Asisten | Aplikasi Presensi</title>
	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.php" class="logo">
					...
					<b class="text-white">Menu Asisten</b>
				</a>
						...
						<li class="nav-item">
							...
							<li class="nav-item">
								...
								<ul class="nav nav-collapse">
									...
									foreach ($mengajar as $dm) { ?>
										<li>
											<a href="?page=nilai&pelajaran=<?=$dm['id_mengajar'] ?> ">
												<span class="sub-item"><!-- <?=strtoupper($dm['matkul']); ?> -->KELAS (<?=strtoupper($dm['nama_kelas']); ?>)</span>
											</a>
										</li>
									<?php } ?>
		...
		<div class="main-panel">
			<div class="content">
				...
				if ($page=='absen') {
					if ($act=='') {
						include 'view/absen/absen_kelas.php';
					}elseif ($act=='surat_view') {
						include 'view/absen/view_surat_izin.php';
					}elseif ($act=='konfirmasi') {
						include 'view/absen/konfirmasi_izin.php';
					}elseif ($act=='update') {
						include 'view/absen/absen_kelas_update.php';
					}					
				}elseif ($page=='rekap') {
					if ($act=='') {
					...
					if ($act=='') {
						include 'view/jadwal/jadwal_megajar.php';

					}					
				}elseif ($page=='nilai') {
					if ($act=='') {
						include 'view/nilai/nilai.php';
					}elseif ($act=='data_nilai') {
						include 'view/nilai/data_nilai.php';
					}elseif ($act=='del_nilai') {
						include 'view/nilai/del_nilai.php';
					}elseif ($act=='edit_nilai') {
						include 'view/nilai/edit_nilai.php';
					}elseif ($act=='proses_nilai') {
						include 'view/nilai/proses_nilai.php';
					}
				}elseif ($page=='akun') {
					include 'view/akun/akun.php';
				}
