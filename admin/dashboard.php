...
<?php
 ...
 ?>
   ...
   // jumlah mahasiswa
$jumlahMahasiswa = mysqli_num_rows(mysqli_query($con,"SELECT * FROM tb_mahasiswa WHERE status=1 "));
// jumlah asisten
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					<!-- <img src="../assets/img/es.png" alt="navbar brand" class="navbar-brand" width="40"> -->
					<b class="text-white" style="font-size: 0.8em;">EMBEDDED SYSTEM</b>
				</a>
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							<a data-toggle="collapse" href="#jadwalmahasiswa">
								<i class="fas fa-clipboard-list"></i>
								<p>Jadwal Mahasiswa</p>
								<span class="caret"></span>
							</a>
							<div class="collapse" id="jadwalmahasiswa">
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=jadwal_mahasiswa&act=add ">
											<span class="sub-item"> Tambah Jadwal </span>
										</a>
									</li>
									<li>
										<a href="?page=jadwal_mahasiswa">
											<span class="sub-item"> Daftar Jadwal Mahasiswa </span>
										</a>
									</li>
								</ul>
							</div>
						...
						<li class="nav-item">
							<a data-toggle="collapse" href="#kalab">
								<i class="fas fa-user-tie"></i>
								<p>Data Kepala Lab</p>
								<span class="caret"></span>
							</a>
							<div class="collapse" id="kalab">
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=kalab&act=add ">
											<span class="sub-item"> Tambah Kepala Lab </span>
										</a>
									</li>
									<li>
										<a href="?page=kalab">
											<span class="sub-item"> Daftar Kepala Lab </span>
										</a>
									</li>
								</ul>
							</div>
		...
		<div class="main-panel">
			<div class="content">
				...
				if ($page=='master') {
					// kelas
					if ($act=='kelas') {
					include 'view/master/kelas/data_kelas.php';
					}elseif ($act=='delkelas') {
					include 'view/master/kelas/del.php';
					// semster
					}elseif ($act=='semester') {
					include 'view/master/semester/data.php'; 
					}elseif ($act=='delsemester') {
					include 'view/master/semester/del.php';
					}elseif ($act=='set_semester') {
						include 'view/master/semester/set.php';
					}
					// tahun ajaran
					elseif ($act=='ta') {
					include 'view/master/ta/data.php'; 
					}elseif ($act=='delta') {
					include 'view/master/ta/del.php';
					}elseif($act=='set_ta'){
						include 'view/master/ta/set.php';
						// matkul
				}elseif ($act=='matkul') {
					include 'view/master/matkul/data.php'; 
					}elseif ($act=='delmatkul') {
					include 'view/master/matkul/del.php';
					}					
				}elseif ($page=='walas') {
					if ($act=='') {
					 include 'view/wakel/data.php';  	
					}
               
               }elseif ($page=='kalab') {
           if ($act=='') {
               include 'view/kalab/data.php'; 
           }elseif ($act=='add') {
                include 'view/kalab/add.php'; 
           }elseif ($act=='edit') {
               include 'view/kalab/edit.php'; 
           }elseif ($act=='del') {
                include 'view/kalab/del.php'; 
           }elseif ($act=='proses') {
                include 'view/kalab/proses.php'; 
           }
            }elseif ($page=='asisten') {
           if ($act=='') {
               include 'view/asisten/data.php'; 
           }elseif ($act=='add') {
                include 'view/asisten/add.php'; 
           }elseif ($act=='edit') {
               include 'view/asisten/edit.php'; 
           }elseif ($act=='del') {
                include 'view/asisten/del.php'; 
           }elseif ($act=='proses') {
                include 'view/asisten/proses.php'; 
           }
        }elseif ($page=='mahasiswa') {
          if ($act=='') {
               include 'view/mahasiswa/data.php'; 
           }elseif ($act=='add') {
                include 'view/mahasiswa/add.php'; 
           }elseif ($act=='edit') {
               include 'view/mahasiswa/edit.php'; 
           }elseif ($act=='del') {
                include 'view/mahasiswa/del.php'; 
           }elseif ($act=='proses') {
                include 'view/mahasiswa/proses.php'; 
           }   
        }
            elseif ($page=='rekap') {
					if ($act=='') {
						include 'view/rekap/rekap_absen.php';
					}elseif ($act='rekap-perbulan') {
						include 'view/rekap/rekap_perbulan.php';
					}					
		}elseif ($page=='jadwal') {
			if ($act=='') {
				include 'view/jadwal/data_mengajar.php';
			}elseif ($act=='add') {
				include 'view/jadwal/tambah.php';
			}elseif ($act=='cancel') {
				include 'view/jadwal/cancel.php';
			}					
		}elseif ($page=='jadwal_mahasiswa') {
			if ($act=='') {
				include 'view/jadwal_mahasiswa/data_jadwal.php';
			}elseif ($act=='add') {
				include 'view/jadwal_mahasiswa/tambah.php';
			}elseif ($act=='cancel') {
				include 'view/jadwal_mahasiswa/cancel.php';
			}					
		}elseif ($page=='') {
