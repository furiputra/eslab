  ...
  <div class="row">
          ...
          <form action="?page=mahasiswa&act=proses" method="post" enctype="multipart/form-data">
            ...
            <table cellpadding="3" style="font-weight: bold;">
              ...
              <tr>
                <td>NIM</td>
                <td>:</td>
                <td><input name="nis" type="text" class="form-control" placeholder="NIM" required> </td>
              </tr>
              <tr>
                <td>Tempat,Tanggal Lahir </td>
                <td>:</td>
                <td><input type="text" class="form-control" name="tempat" placeholder="Tempat Lahir" required></td>
                <td>/</td>
                <td><input type="date" class="form-control" name="tgl" placeholder="Tanggal Lahir" required></td>
              </tr>
              <tr>
                <td>Jenis Kelamin </td>
                <td>:</td>
    ...
    ORDER BY id_mkelas ASC");
              ...
              <tr>
                <td>Tahun Masuk</td>
                <td>:</td>
                <td><input name="th_masuk" type="number" class="form-control" placeholder="2019" required></td>
              </tr>
              <tr>
                <td>Pas Foto</td>
                <td>:</td>
