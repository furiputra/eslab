...
$edit = mysqli_query($con,"SELECT * FROM tb_kalab WHERE id_kalab='$_GET[id]' ");
foreach ($edit as $d)?>
<div class="page-inner">
          <div class="page-header">
            ...
            <ul class="breadcrumbs">
              ...
              <li class="nav-item">
                <a href="#">Edit Kepala Laboratorium</a>
              </li>
            </ul>
          </div>
          <div class="row">
                <div class="col-lg-8">
                  <div class="card">
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Form Edit Kepala Laboratorium</h3>
                    </div>
                    <div class="card-body">
						<form action="?page=kalab&act=proses" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<label>NIP/NUPTK</label>
								<input type="hidden" name="id" value="<?=$d['id_kalab'] ?>">
								<input name="nip" type="text" class="form-control" value="<?=$d['nip'] ?>" readonly>								
							</div>

							<div class="form-group">
								<label>Nama Kepala Laboratorium</label>
								<input name="nama" type="text" class="form-control" value="<?=$d['nama_kalab'] ?>">								
							</div>
...
<!-- 
							...
							<div class="form-group">
								<button name="editkalab" type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Update</button>
