<div class="page-inner">
          <div class="page-header">
            ...
            <ul class="breadcrumbs">
              ...
              <li class="nav-item">
                <a href="#">Tambah Kepala Laboratorium</a>
              </li>
            </ul>
          </div>
          <div class="row">
                ...
                <div class="col-lg-8">
                  <div class="card">
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Form Entry Kepala Laboratorium</h3>
                    </div>
                    <div class="card-body">
						<form action="?page=kalab&act=proses" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<button name="saveKalab" type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Simpan</button>
