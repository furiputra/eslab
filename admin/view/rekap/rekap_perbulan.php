...
<div class="page-inner">
	<div class="page-header">
		<h4 class="page-title"><?= strtoupper($d['matkul']) ?> </h4>
	...
	<div class="row">
 	 ...
 	 -->
				...
				<div class="card-body">
					<a target="_blank" href="../asisten/view/rekap/rekap_persemester.php?pelajaran=<?= $_GET['pelajaran'] ?>&bulan=<?= $bulan; ?>&kelas=<?= $_GET['kelas'] ?>" class="btn btn-default">
			 ...
			 ");
					...
					foreach ($qry as $bulan) { ?>
						...
						<div class="alert alert-warning alert-dismissible mt-2" role="alert">
							...
							<p>
								<a target="_blank" href="../asisten/view/rekap/rekap_bulanxl.php?pelajaran=<?= $_GET['pelajaran'] ?>&bulan=<?= $bulan; ?>&kelas=<?= $_GET['kelas'] ?>" class="btn btn-success">
									<span class="btn-label">
										<i class="far fa-file-excel"></i>
									</span>
									Export Excell
								</a>
								<a target="_blank" href="../asisten/view/rekap/rekap_bulan.php?pelajaran=<?= $_GET['pelajaran'] ?>&bulan=<?= $bulan; ?>&kelas=<?= $_GET['kelas'] ?>" class="btn btn-default">
									<span class="btn-label">
										<i class="fas fa-print"></i>
									</span>
							...
							<table width="100%" border="1" cellpadding="2" style="border-collapse: collapse;">
								...
								$qryAbsen = mysqli_query($con, "SELECT * FROM _logabsensi INNER JOIN tb_mahasiswa ON _logabsensi.id_mahasiswa=tb_mahasiswa.id_mahasiswa
