                      ...
                      <div class="table-responsive">
                        <table id="basic-datatables" class="display table table-striped table-hover" >
                          ...
                          <tbody>
                            <?php 
                            $no=1;
                              $matkul = mysqli_query($con,"SELECT * FROM tb_mengajar 
                            ...
                            <tr>
                              ...
                              <td>
                                <a href="?page=jadwal&act=cancel&id=<?=$d['id_mengajar'];?>" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Hapus</a>
