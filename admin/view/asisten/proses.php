...
if (isset($_POST['saveAsisten'])) {
    ...
    $pass= sha1($_POST['nip']);
		...
		if ($pindah) {
			$save= mysqli_query($con,"INSERT INTO tb_asisten VALUES(NULL,'$_POST[nip]','$_POST[nama]','$_POST[email]','$pass','$nama_gambar','Y') ");
			if ($save) {
				echo "
  	 ...
  	 $pass= sha1($_POST['email']);
		...
		$editAsisten= mysqli_query($con,"UPDATE tb_asisten SET nama_asisten='$_POST[nama]',email='$_POST[email]' WHERE id_asisten='$_POST[id]' ");
