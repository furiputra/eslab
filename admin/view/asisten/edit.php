...
$edit = mysqli_query($con,"SELECT * FROM tb_asisten WHERE id_asisten='$_GET[id]' ");
foreach ($edit as $d)?>
                    ...
                    <div class="card-body">
						<form action="?page=asisten&act=proses" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input name="nama" type="text" class="form-control" value="<?=$d['nama_asisten'] ?>">								
							</div>
