				...
				<div class="card-body">
					<div class="card-title">
						<center>
							...
							<br>
							<b>Embedded System Laboratory</b>
						</center>
					</div>
					<div class="card-category">
						<center>
							Menara PLN lantai 3, Jl. Lkr. Luar Barat Lantai 2, RT.1/RW.1, Duri Kosambi, Kecamatan Cengkareng, Kota Jakarta Barat, Daerah Khusus Ibukota Jakarta 11750
							<br>Email : embeddedsystemlab@itpln.ac.id, Telp.085156131965, Instagram : @embeddedsystemlab_itpln
						</center>
					</div>
					...
					<div class="tab-content mt-2 mb-3" id="pills-with-icon-tabContent">
						...
						<div class="tab-pane fade" id="pills-contact-icon" role="tabpanel" aria-labelledby="pills-contact-tab-icon">
							<p>
								...
								Aplikasi Absensi mahamaha ini dibuat untuk mendokumentasikan kehadiran mahasiswa, Aplikasi sangat Mudah digunakan (Berbasis Web)
							</p>
						</div>
					</div>
				</div>
